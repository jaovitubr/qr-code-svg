...
-----------------------|-------------------------|-------------|-----------------------------------------------------
width                  |number                   |`300`        |Size of svg
height                 |number                   |`300`        |Size of svg
...
types    |string (`'rounded' 'dots' 'classy' 'classy-rounded' 'square' 'extra-rounded'`)|`'square'`   |Style of QR dots
...
`QRCodeStyling.download(filename) => Promise<void>`

Param          |Type  |Description
---------------|------|------------
filename|string|Name of file (not required)
